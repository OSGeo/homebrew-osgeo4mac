...
class Gdal2Python < Formula
  ...
  bottle do
    ...
    cellar :any
    rebuild 2
    sha256 "6e1d2f817dd573afd16129eefba59eb0be834613d26a83d9e562345f2835d261" => :high_sierra
    sha256 "6e1d2f817dd573afd16129eefba59eb0be834613d26a83d9e562345f2835d261" => :sierra
  end
