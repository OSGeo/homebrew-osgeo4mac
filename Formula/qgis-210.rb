...
class Qgis210 < Formula
  ...
  # patche to fix grass compile eror see https://github.com/qgis/QGIS/commit/d722f5bd4b8
  # see: https://github.com/qgis/QGIS/commits/release-2_10_1
  stable do
    patch do
      url "https://gist.githubusercontent.com/christianurich/087caee6e67a06e41b84/raw/4fdcd705da9a3974879eaca1d61b8f0040af0cf6/qgis_210_patch_grass_compile_error"
      sha1 "59b2b221bc9acdca2bb015a116aa7eb043aef0a8"
    end
  end
