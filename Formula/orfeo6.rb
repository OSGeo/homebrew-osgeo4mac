class Orfeo6 < Formula
  ...
  bottle do
    ...
    cellar :any
    rebuild 2
    sha256 "5431274c941da0c67b5772a00e033f502341669fb9a17e3a6143f67b8f2cd3d8" => :high_sierra
  ...
  resource "qgis_otb_plugin" do
    # url "https://gitlab.orfeo-toolbox.org/orfeotoolbox/qgis-otb-plugin.git", :branch => "master"
    url "https://gitlab.orfeo-toolbox.org/orfeotoolbox/qgis-otb-plugin/-/archive/master/qgis-otb-plugin-master.tar.gz"
    sha256 "dca8f324fe273849187af2dc56ae40b98538736b42daa9c3a02b486db4f8f409"
    version "0.1"
  end
  ...
  def install
    ...
    if build.with? "python"
      ...
      # args << "-DPYTHON_LIBRARIES=#{HOMEBREW_PREFIX}/Frameworks/Python.framework/Versions/#{py_ver}/lib/libpython#{py_ver}.dylib" # not used by the project
      # args << "-DPYTHON_INCLUDE_PATH=#{HOMEBREW_PREFIX}/Frameworks/Python.framework/Versions/#{py_ver}/include/python#{py_ver}m" # not used by the project
    ...
    mkdir "qgis_otb_plugin"
    (prefix/"qgis_otb_plugin").install resource("qgis_otb_plugin")
