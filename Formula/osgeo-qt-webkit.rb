class OsgeoQtWebkit < Formula
  ...
  bottle do
    ...
    sha256 "ce086ce8d4df605a2fbcb1b9b9c82632588b077b5a4aa7c236410f94da7157ec" => :high_sierra
    sha256 "3dcf4776cd4153c302fb8209bd438b0c2672ac92dabc88df3322141602934b99" => :sierra
  end
